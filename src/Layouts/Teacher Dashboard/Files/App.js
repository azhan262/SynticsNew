        ...
        <div className="row">
          ...
          <div className="col-md-10 col-sm-10">
              <Switch>
                ...
                <Route path="/adult-course-content-text-qa" component={CourseContentAdultTextQA} />
                <Route path="/adult-course-content-text-mcq" component={CourseContentAdultMCQ} />
                <Route path="/adult-course-content-text-blanks" component={CourseContentAdultBlanks} />
                <Route path="/adult-course-content-text-pronunciation" component={Pronunciation} />
                <Route path="/adult-course-content-text-qa-test" component={CourseContentAdultTextForTest} />
                <Route path="/adult-course-content-text-mcq-test" component={CourseContentAdultMCQForTest} />
                <Route path="/adult-course-content-text-blanks-test" component={CourseContentAdultBlanksForTest} />
                <Route path="/adult-course-content-text-pronunciation-test" component={PronunciationForTest} />
                <Route path="/adult-course-content-file-upload" component={filesUploadComponent} />
