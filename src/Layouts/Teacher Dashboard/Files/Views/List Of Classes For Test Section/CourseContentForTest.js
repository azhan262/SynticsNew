...
function CourseContentForTestForTeacher() {
  ...
  const onSubmitHandler = async (data) => {
    ...
    if ((data.questiontype === "Text") && (data.answertype === "English Text")){
      history.push({
        pathname:`/teacher/adult-course-content-text-qa-test/${id}`,
        state: data
      })
    }
    else if ((data.questiontype === "Text") && (data.answertype === "Multiple Choice")){
      history.push({
        pathname:`/teacher/adult-course-content-text-mcq-test/${id}`,
        state: data
      })
    }
    else if ((data.questiontype === "Text") && (data.answertype === "Audio")){
      history.push({
        pathname:`/teacher/adult-course-content-text-audio-test/${id}`,
        state: data
      })
    }
    else if ((data.questiontype === "Text") && (data.answertype === "Video")){
      history.push({
        pathname:`/teacher/adult-course-content-text-video-test/${id}`,
        state: data
      })
    }
    else if ((data.questiontype === "Text") && (data.answertype === "Audio")){
      ...
      history.push({
        pathname:`/teacher/adult-course-content-text-blanks-test/${id}`,
        state: data
      })
    }
    else if ((data.questiontype === "Text") && (data.answertype === "Handwriting")){
      history.push({
        pathname:`/teacher/adult-course-content-text-handwriting-test/${id}`,
        state: data
      })
    }
    else if ((data.questiontype === "Text") && (data.answertype === "Digital Urdu")){
      history.push({
        pathname:`/teacher/adult-course-content-text-digitalUrdu-test/${id}`,
        state: data
      })
    }
    else if ((data.questiontype === "Text") && (data.answertype === "Drawing")){
      history.push({
        pathname:`/teacher/adult-course-content-text-drawing-test/${id}`,
        state: data
      })
    }
    else if ((data.questiontype === "File Upload")){
      history.push({
        pathname:`/teacher/adult-course-content-file-upload-test/${id}`,
        state: data
      })
    }
