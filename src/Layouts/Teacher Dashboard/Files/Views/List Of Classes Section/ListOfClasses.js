...
function ListOfClassesForTeacher() {
  ...
  const handleClick = (e) => {
    ...
    if (e.target.value == "Grade 1"){
      history.push(`/teacher/Grade-1-content/${id}`)
    }
    else if (e.target.value == "Grade 2"){
      history.push(`/teacher/Grade-2-content/${id}`)
    }
    else if (e.target.value == "Grade 3"){
      history.push(`/teacher/Grade-3-content/${id}`)
    }
    else if (e.target.value == "Grade 4"){
      history.push(`/teacher/Grade-4-content/${id}`)
    }
    else if (e.target.value == "Grade 5"){
      history.push(`/teacher/Grade-5-content/${id}`)
    }
    else if (e.target.value == "Grade 6"){
      history.push(`/teacher/Grade-6-content/${id}`)
    }
    else if (e.target.value == "Grade 7"){
      history.push(`/teacher/Grade-7-content/${id}`)
    }
    else if (e.target.value == "Grade 8"){
      history.push(`/teacher/Grade-8-content/${id}`)
    }
    else if (e.target.value == "Grade 9"){
      history.push(`/teacher/Grade-9-content/${id}`)
    }
    else if (e.target.value == "Grade 10"){
      history.push(`/teacher/Grade-10-content/${id}`)
    }
    else if (e.target.value == "Grade 11"){
      history.push(`/teacher/Grade-11-content/${id}`)
    }
    else if (e.target.value == "Grade 12"){
      history.push(`/teacher/Grade-12-content/${id}`)
    }
