    ...
    <div className="card shadow mb-4 text-center">
      ...
      <div className = "mt-4">
                    <div class="p-3 mb-2 " style = {{color : "white", backgroundColor : "#a98799"}}>
                        ...
                        <a className = "text-dark" style={{textDecoration : "none", fontWeight: "bold"}} href={`http://localhost:7000/api/file/display/${location.state.referenceName}`}>{location.state.referenceName}</a>
                        </div>
                        <hr />
                    </div>
                    <div className = "mt-4">
