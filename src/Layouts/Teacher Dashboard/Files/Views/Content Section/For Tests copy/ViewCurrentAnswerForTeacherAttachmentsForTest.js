    ...
    <div className="card shadow mb-4 text-center">
      ...
      <div className = "mt-4">
                    <div class="p-3 mb-2 " style = {{color : "white", backgroundColor : "#a98799"}}>
                        ...
                        <img className = "text-dark" style={{textDecoration : "none", fontWeight: "bold", height:"300px", width:"400px", boxShadow: "5px 5px #888888"}} src={`http://localhost:7000/api/file/display/${location.state.referenceName}`}>
                        </img>
                        </div>
                        <hr />
                    </div>
