...
function CategoryForPerfomance() {
  ...
  <Row className="mt-3">
      ...
      <div className="containerResultCategory mt-3 mb-3">
                              <button className="btnResultCategory play-pause buttonResultCategory" style = {{fontWeight : "bold", height: "110px", width: "110px" }} onClick={(e) => onSubjectClick(e)}>
        ...
        <Col md="6">
        <div className="containerResultCategory mt-3 mb-3">
                              <button className="btnResultCategory play-pause buttonResultCategory" style = {{fontWeight : "bold", height: "110px", width: "110px" }} onClick={(e) => onTestClick(e)}>
