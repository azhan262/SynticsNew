                 ...
                 </div>
                 {
                              items.map(contents => (
                                  <div className="page" key={contents._id}>
                                    ...
                                    <div className = "mt-5">
                                      <img className = "text-dark" style={{textDecoration : "none", fontWeight: "bold", height:"300px", width:"400px", boxShadow: "5px 5px #888888"}} src={`http://localhost:7000/api/file/display/${contents.referenceName}`}>
                                      </img>
                                    </div>
