...
function Grade5ContentTestForStudent() {
  ...
  const handleOnClick = (data) => {
    if ((data.answertype == "English Text")){
      history.push({
                          ...
                          items != null ? items.map(contents => (
                                ...
                                <td>
                                  <div className="containerTestimonialButton mt-3 mb-3">
                                    <button className="btnTestimonialButton play-pause buttonTestimonialButton" style={{width: "90px", height: "90px"}} onClick={() => handleOnClick(contents)}>View Question</button>
                                  </div>
                                </td>
                                </tr>
                            )) : 
