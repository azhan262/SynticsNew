...
function ResultsForTestForStudents() {
    ...
    useEffect(() => {
      const fetchItems = async function() {
        const contents = await getAnswerSpecificWithSubjectTest(id, location.state)
                              ...
                              answers.map(contents => (
                                  ...
                                  <td>
                                    <div className="buttonNewTheme mt-3 mb-3 text-center">
                                      <button className="btnSass play-pause buttonSass" style = {{fontWeight : 'bold', height:"108px", width: "108px"}}  onClick={() => handleOnClick(contents)}>View</button>
                                    </div>
                                  </td>
                                  </tr>
                              ))
