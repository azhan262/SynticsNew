      ...
      <div className="card-body">
                  ...
                  <div class="spacer"></div>
                   <div className="buttonNewTheme mt-3 mb-2">
                      <button id="undo" className="btnSass play-pause buttonSass" style={{height:"80px", width:"80px"}} disabled>
                      <i className="fas fa-undo-alt fa-2x"></i>
                      </button>
                      &nbsp;&nbsp;&nbsp;
                      <button id="redo" className="btnSass play-pause buttonSass" style={{height:"80px", width:"80px"}} disabled>
                      <i className="fas fa-redo-alt fa-2x"></i>
                      </button>
                      &nbsp;&nbsp;&nbsp;
                      <button id="clear" className="btnSass play-pause buttonSass" style={{height:"80px", width:"80px"}} disabled>
                    ...
                    */}
                    ...
                    <div className="containerSass mt-3 mb-2">
                        <button className="btnSass play-pause buttonSass" onClick = {(e) => onSubmit(e)}>
                        Submit Answer
                        </button>
                    </div>
