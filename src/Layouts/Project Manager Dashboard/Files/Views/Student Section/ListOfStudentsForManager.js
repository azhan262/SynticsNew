...
function ListOfStudentsForManager() {
    let {id} = useParams()
    ...
    useEffect(() => {
      const fetchItems = async function() {
        ...
        const teachers = await getRegistrations(course)
        setItems(teachers)
      }
      fetchItems()
    }, []);
                          ...
                          <tbody>
                              ...
                              items.map(students => (
                                  ...
                                  <td>
                                      ...
                                      <button className="btn btn-primary"  onClick={() => handleOnClickInfo(students)}>View Info</button>
                                   
                                  </td>
                                  <td>
                                   
                                      <button className="btn btn-primary"  onClick={() => handleOnClickApprove(students)}>Approve</button>
                                    
                                  </td>
                                  <td>
                                    
                                      <button className="btn btn-primary"  onClick={() => handleOnClickDisapprove(students)}>Disapprove</button>
                                  
                                  </td>
                                  <td>
                                   
                                      <button className="btn btn-primary"  onClick={() => handleOnClickRemove(students)}>Remove</button>
...
export default ListOfStudentsForManager
